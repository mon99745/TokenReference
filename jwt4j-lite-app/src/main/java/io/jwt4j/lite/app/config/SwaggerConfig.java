package io.jwt4j.lite.app.config;

import io.jwt4j.lite.app.controller.KeyPairRestController;
import io.jwt4j.lite.app.controller.TokenRestController;
...
//						new Tag(SignDocRestController.TAG, "서명 문서(Signature Document) 관리 API", 300)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("io.jwt4j.lite.app.controller"))
				.build();
	}
